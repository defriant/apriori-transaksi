...
<body>
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-fixed-top">
            <div class="brand">
                <a href="/dashboard"><img src="{{ asset('assets/img/mutiara_teknik_logo.png') }}" class="img-responsive logo"></a>
            </div>
            ...
            <div class="sidebar-scroll">
                <nav>
                    <ul class="nav">
                        ...
                        <li>
                            <a href="/produk" class="{{ Request::is('produk') ? 'active' : '' }}"><i class="fal fa-boxes"></i> <span>Produk</span></a>
                        </li>
                        <li>
                            <a href="/transaksi" class="{{ Request::is('transaksi') ? 'active' : '' }}"><i class="fal fa-sack-dollar"></i> <span>Transaksi</span></a>
                        </li>
                        <li>
                            <a href="/asosiasi" class="{{ Request::is('asosiasi') ? 'active' : '' }}"><i class="fal fa-chart-network"></i> <span>Asosiasi Penjualan</span></a>
                        </li>
                    </ul>
                </nav>
            </div>
    ...
    @elseif (Request::is('asosiasi'))
        <script src="{{ asset('assets/scripts/asosiasiComponent.js') }}"></script>
        <script src="{{ asset('assets/scripts/asosiasi.js') }}"></script>
    @endif
    @yield('scripts')
</body>
