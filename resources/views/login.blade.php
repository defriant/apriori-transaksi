			...
			<div class="vertical-align-middle">
				<div class="auth-box ">
					<div class="left">
						<div class="content">
							<div class="header">
								<div class="logo text-center"><img src="{{ asset('assets/img/mutiara_teknik_logo.png') }}" class="login-logo"></div>
					...
					<div class="right">
						...
						<div class="content text">
							<h1 class="heading">Mutiara Teknik</h1>
							<p>Alat & Sparepart Elektronik</p>
						</div>
					</div>
